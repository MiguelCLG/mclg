          ...
          <div className="page-wrapper">
            <div className="page-inner-wrapper">
              <div className="group">
                ...
                <div className="game-cols span_1_of_3"><a className="font-persona text-light text-white" href={"SpaceInvaders/index.html"} target="_blank" rel="noopener noreferrer"><img src={require("../images/spaceinvaders.jpg")} alt="Knightly Duel" className="game-thumbnails"/>Space Invaders</a></div>

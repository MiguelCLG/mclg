          ...
          <div className="page-wrapper">
            <div className="page-inner-wrapper">
              <div className="group">
                ...
                <div className="game-cols span_1_of_3"><a className="font-persona text-light text-white" href={"BlockBreaker/index.html"} target="_blank" rel="noopener noreferrer"><img src={require("../images/blockbreaker.jpg")} alt="Block Breaker" className="game-thumbnails"/>Block Breaker</a></div>
